...
namespace IIS.12345
{
    ...
    public class Контроллер : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.12345.Сенсоры fСенсоры;
        ...
        [PropertyStorage(new string[] {
                "Сенсоры"})]
        [NotNull()]
        public virtual IIS.12345.Сенсоры Сенсоры
        {
            get
            {
                ...
                IIS.12345.Сенсоры result = this.fСенсоры;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.12345.Серверная.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КонтроллерE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтроллерE", typeof(IIS.12345.Контроллер));
                }
            }
        }
    }
    ...
    public class DetailArrayOfКонтроллер : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.12345.DetailArrayOfКонтроллер members)

        // *** End programmer edit section *** (IIS.12345.DetailArrayOfКонтроллер members)
        ...
        /// </summary>
        public DetailArrayOfКонтроллер(IIS.12345.Серверная fСерверная) : 
                base(typeof(Контроллер), ((ICSSoft.STORMNET.DataObject)(fСерверная)))
        {
        }
        
        public IIS.12345.Контроллер this[int index]
        {
            get
            {
                return ((IIS.12345.Контроллер)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.12345.Контроллер dataobject)
        {
